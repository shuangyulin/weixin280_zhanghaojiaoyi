  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='maijia'"  label="卖家邮箱" prop="maijiayouxiang">
          <el-input v-model="ruleForm.maijiayouxiang"               placeholder="卖家邮箱" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='maijia'"  label="信用分" prop="xinyongfen">
          <el-input v-model="ruleForm.xinyongfen" readonly              placeholder="信用分" clearable></el-input>
        </el-form-item>
      </el-col>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if( 'maijia' ==this.flag && this.ruleForm.maijiayouxiang&&(!isEmail(this.ruleForm.maijiayouxiang))){
        this.$message.error(`卖家邮箱应输入邮箱格式`);
        return
      }
      if( 'maijia' ==this.flag && this.ruleForm.xinyongfen&&(!isIntNumer(this.ruleForm.xinyongfen))){
       this.$message.error(`信用分应输入整数`);
        return
      }
