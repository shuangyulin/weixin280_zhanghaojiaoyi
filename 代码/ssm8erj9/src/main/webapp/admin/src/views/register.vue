  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='maijia'" class="input-group">
			   <div class="label">卖家邮箱</div>
			   <div class="input-container">
			     <input v-model="ruleForm.maijiayouxiang" class="input" type="text" placeholder="卖家邮箱">
			   </div>
			 </div> -->
			<el-form-item label="卖家邮箱" class="input" v-if="tableName=='maijia'">
			  <el-input v-model="ruleForm.maijiayouxiang" autocomplete="off" placeholder="卖家邮箱"  />
			</el-form-item>
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.lianxidianhua) && `maijia` == this.tableName){
      ...
      if(`maijia` == this.tableName && this.ruleForm.maijiayouxiang&&(!this.$validate.isEmail(this.ruleForm.maijiayouxiang))){
        this.$message.error(`卖家邮箱应输入邮件格式`);
        return
      }
      if(`maijia` == this.tableName && this.ruleForm.xinyongfen&&(!this.$validate.isIntNumer(this.ruleForm.xinyongfen))){
        this.$message.error(`信用分应输入整数`);
        return
      }
      this.$http({
