<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="游戏类别" prop="youxileibie">
          <el-input v-model="ruleForm.youxileibie" 
              placeholder="游戏类别" clearable  :readonly="ro.youxileibie"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="退货说明" prop="tuihuoshuoming">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="退货说明"
                  v-model="ruleForm.tuihuoshuoming" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.tuihuoshuoming" label="退货说明" prop="tuihuoshuoming">
                    <span>{{ruleForm.tuihuoshuoming}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.maijiayouxiang = true;
          ...
          if(o=='tuihuoshuoming'){
            this.ruleForm.tuihuoshuoming = obj[o];
	    this.ro.tuihuoshuoming = true;
            continue;
          }
          if(o=='tuihuoshijian'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zhanghaotuihuo/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zhanghaotuihuoCrossAddOrUpdateFlag = false;
						 this.parent.search();
